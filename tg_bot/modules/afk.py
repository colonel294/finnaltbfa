...
__help__ = """
 - !دایورت <دلیل>: خودتون رو دور از دسترس علامت بزنید!.
 

دایورت. قابلیت کاربردی به شرط استفاده درست !! 
وقتی نیستید تو گپ  ، دستور !دایورت رو بزنید من به شخصی که آیدیتون رو بنویسه میگم که نیستید
به محض اولین پیام تو گپ حالتتون در دسترس اعلام میشه!
"""

__mod_name__ = "دور از دسترس"

AFK_HANDLER = DisableAbleCommandHandler("دایورت", afk)

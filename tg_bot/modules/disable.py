...
if is_module_loaded(FILENAME):
 ...
 - !خاموشها: همه دستوراتی که غیر فعال هستند رو نشون میدم

*فقط ادمینها:*
 - !روشن <نام دستور> : اون دستورو فعال میکنم
 - !خاموش <نام دستور> : اون دستور رو غیر فعال میکنم
 - !دستورات : لیست همه دستوراتی که میتونی فعال یا غیر فعال کنی رو نشون میدم
    """

    DISABLE_HANDLER = CommandHandler("خاموش", disable, pass_args=True, filters=Filters.group)
    ENABLE_HANDLER = CommandHandler("روشن", enable, pass_args=True, filters=Filters.group)
    COMMANDS_HANDLER = CommandHandler(["خاموشها", "disabled"], commands, filters=Filters.group)
    TOGGLE_HANDLER = CommandHandler("دستورات", list_cmds, filters=Filters.group)

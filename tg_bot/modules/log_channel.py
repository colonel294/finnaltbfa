...
if is_module_loaded(FILENAME):
    ...
    def setlog(bot: Bot, update: Update):
        ...
        if chat.type == chat.CHANNEL:
            message.reply_text("خب حالا پیام !اخبار رو فوروارد کن به گپت")
            ...
            message.reply_text("مراحل لینک کردن من و کانال:\n"
                               " - منو ادد کن تو چنلت\n"
                               " - دستور !اخبار رو داخل چنل بفرس\n"
                               " - پیام !اخبار رو فوروارد کن تو گپت\n")
    ...
    __help__ = """
	یه قابلیت جالب به عنوان آنتن! 
	کاراییش شبیه recent action گپه ولی دقیق تر
	با جزعیات بیشتر.  
	
	
*فقط ادمینها:*
- !شبکه : اطلاعات کانال اخبار رو بهتون میده
- !اخبار : تنظیم کانال اخبار.
- !اخبار0 : قطع اتصال با چنل اخبار.

تنظیم کانال خبر:
- به عنوان ادمین رباتو به کانالتون اضافه کنید!
- دستور !اخبار رو به چنلتون بفرستین
- پیام !اخبار رو به گپتون فوروارد کنید!
"""

    __mod_name__ = "آنتن"

    LOG_HANDLER = CommandHandler("شبکه", logging)
    SET_LOG_HANDLER = CommandHandler("اخبار", setlog)
    UNSET_LOG_HANDLER = CommandHandler("اخبار0", unsetlog)

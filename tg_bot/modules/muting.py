...
__help__ = """
*فقط ادمینها:*
 - !سکوت <آیدی> : کاربری که آیدیش رو زدی یا روش ریپلی زدی رو ساکت میکنم.
 - !سایلنت <آیدی> عدد(دقیقه\ساعت\روز) : 
 کاربری که ریپلی بزنی یا آیدیش رو بنویسی با مدت مشخص سکوت میزنم.
برای مثال : !سایلنت 4ساعت (به علاوه ریپلی روی شخص) 
نکته : لطفا بعد از عدد بدون فاصله زمان رو بنویسید
 -!آزاد <آیدی> : کاربری که ریپلی زدی یا آیدیش رو نوشتی آزاد میکنم.
"""

__mod_name__ = "سکوت🤫"

MUTE_HANDLER = CommandHandler("سکوت", mute, pass_args=True, filters=Filters.group)
UNMUTE_HANDLER = CommandHandler("آزاد", unmute, pass_args=True, filters=Filters.group)
TEMPMUTE_HANDLER = CommandHandler(["سایلنت", "tempmute"], temp_mute, pass_args=True, filters=Filters.group)

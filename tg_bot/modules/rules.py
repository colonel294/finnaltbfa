...
__help__ = """
 -!قوانین : قوانین گپ رو میدم بهت.

*فقط ادمینها:*
 -!باقانون <متن>:  قوانین گپ رو تنظیم میکنم برات.
...
RESET_RULES_HANDLER = CommandHandler("بیقانون", clear_rules, filters=Filters.group)

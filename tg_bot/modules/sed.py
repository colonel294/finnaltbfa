...
__help__ = """
 یه قابلیت جالب . دسترسی به سایت های دانلود !
 برای دانلود فایلی که کاربر بهش مشتاقه و ارسالش به صورت فایل
 
 *نکته* : متاسفانه به دلیل کم آوردن سرور مجبور شدم حذفش کنم
 کدهاش کامله ، *به زودی* منتظر من باشید
"""

__mod_name__ = "استخراج گر📥"

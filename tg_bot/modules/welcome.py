...
WELC_PREF_HANDLER = RegexHandler("(?i)خوشامد(s)?", welcome, pass_args=True, filters=Filters.group)
GOODBYE_PREF_HANDLER = RegexHandler("(?i)خدافظی(s)?", goodbye, pass_args=True, filters=Filters.group)
SET_WELCOME = RegexHandler("(?i)تنظیم خوشامد(s)?", set_welcome, filters=Filters.group)
SET_GOODBYE = RegexHandler("(?i)تنظیم خدافظی(s)?", set_goodbye, filters=Filters.group)
RESET_WELCOME = RegexHandler("(?i)خوشامدپیشفرض(s)?", reset_welcome, filters=Filters.group)
RESET_GOODBYE = RegexHandler("(?i)خدافظی پیشفرض(s)?", reset_goodbye, filters=Filters.group)
CLEAN_WELCOME = RegexHandler("(?i)خوشامدمرتب(s)?", clean_welcome, pass_args=True, filters=Filters.group)
WELCOME_HELP = RegexHandler("(?i)راهنمای خوشامد(s)?", welcome_help)

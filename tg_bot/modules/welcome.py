...
WELC_PREF_HANDLER = RegexHandler(["(?i)خوشامد(s)?", "welcome"], welcome, pass_args=True, filters=Filters.group)
GOODBYE_PREF_HANDLER = RegexHandler(["(?i)خدافظی(s)?", "goodbye"], goodbye, pass_args=True, filters=Filters.group)
SET_WELCOME = RegexHandler(["(?i)تنظیم خوشامد(s)?", "setwelcome"], set_welcome, filters=Filters.group)
SET_GOODBYE = RegexHandler(["(?i)تنظیم خدافظی(s)?", "setgoodbye"], set_goodbye, filters=Filters.group)
RESET_WELCOME = RegexHandler(["(?i)خوشامدپیشفرض(s)?", "resetwelcome"], reset_welcome, filters=Filters.group)
RESET_GOODBYE = RegexHandler(["(?i)خدافظی پیشفرض(s)?", "resetgoodbye"], reset_goodbye, filters=Filters.group)
CLEAN_WELCOME = RegexHandler(["(?i)خوشامدمرتب(s)?", "cleanwelcome"], clean_welcome, pass_args=True, filters=Filters.group)
WELCOME_HELP = RegexHandler(["(?i)راهنمای خوشامد(s)?", "welcomehelp"], welcome_help)

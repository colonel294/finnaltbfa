...
SET_WELCOME = CommandHandler(["(?i)تنظیمخوشامد(s)?", "setwelcome"], set_welcome, filters=Filters.group)
SET_GOODBYE = CommandHandler(["(?i)تنظیمخدافظی(s)?", "setgoodbye"], set_goodbye, filters=Filters.group)
RESET_WELCOME = CommandHandler(["(?i)خوشامدپیشفرض(s)?", "resetwelcome"], reset_welcome, filters=Filters.group)
RESET_GOODBYE = CommandHandler(["(?i)خدافظیپیشفرض(s)?", "resetgoodbye"], reset_goodbye, filters=Filters.group)
CLEAN_WELCOME = CommandHandler(["(?i)خوشامدمرتب(s)?", "cleanwelcome"], clean_welcome, pass_args=True, filters=Filters.group)
WELCOME_HELP = CommandHandler(["(?i)راهنمایخوشامد(s)?", "welcomehelp"], welcome_help)
